                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="default_deletion_time" name="settings[default_deletion_time]" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        ...
                                        <option value="72" {{ isset($settings['default_deletion_time']) && $settings['default_deletion_time'] == '72' ? 'selected' : '' }}>72 hours</option>
                                        <option value="168" {{ isset($settings['default_deletion_time']) && $settings['default_deletion_time'] == '168' ? 'selected' : '' }}>7 days</option>
                                        <option value="720" {{ isset($settings['default_deletion_time']) && $settings['default_deletion_time'] == '720' ? 'selected' : '' }}>30 days</option>
                                    </select>
